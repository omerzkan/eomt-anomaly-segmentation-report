...
\begin{itemize}
    ...
    \item For code development of the project, we used Claude by Anthropic. This tool is used for these reasons:
    \begin{itemize}
        ...
        \item Reviewing the formulas, and help with the structring the repository
