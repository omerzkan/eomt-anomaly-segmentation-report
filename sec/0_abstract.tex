...
Semantic and anomaly segmentation is critical for autonomous driving. 
...
Our findings show that EoMT-Cityscapes with MSP reaches 74.36\% AuPRC on RoadAnomaly21, and RbA helps lowering false positive rates. 
Our code is available at \url{https://github.com/omerzkan/eomt-anomaly-segmentation.git}.
